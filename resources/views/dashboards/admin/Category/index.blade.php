                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if ($item->status == 1)
                                <a href="{{ url('admin-category-delete/'.$item->id) }}" class="badge badge-pill btn-danger px-3 py-2">Deactivate</a>
                                @else
                                <a href="{{ url('admin-category-activate/'.$item->id) }}" class="badge badge-pill btn-success px-3 py-2">Activate</a>
                                @endif
                            </td>
